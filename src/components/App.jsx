  ...
  return (
    <Container>
      ...
      <Routes>
        ...
        {/* <Route path="/routes" element={<Authorization setCurrUser={setCurrUser} />} /> */}
        <Route path="/:routeId" element={<OneRoute />} />
        {/* <Route path="/routes" element={<Route currUser={currUser} />} /> */}
        {/* <Route path="/route/reviews" element={<Reviews currUser={currUser} />} /> */}
      </Routes>
    </Container>
  );
}
